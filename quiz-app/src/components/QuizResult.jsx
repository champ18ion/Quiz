   ...
   <MDBContainer fluid className='result'> 
    <div className='result'>
      ...
      <div className="d-flex flex-column text-center">
        <img src={trophy} alt="" srcset="" className='img-fluid' width={30} />
      Your Score:
      <big className={ score>=7?'text-success display-2':'text-danger display-2'}>{score} / {questions.length}</big>
      <br />
      <span className='text-info '>Time Taken: <big>{timeTaken}</big> seconds</span>
      </div>
